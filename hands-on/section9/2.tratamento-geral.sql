...
/*
 * EX1: Agrupamento de dados com CASE WHEN
 * Calcule o n° de clientes que ganham abaixo de 5k, entre 5k e 10k, entre 10k e 15k
 * e acima de 15k
 * */
...
/*
 * EX2: Tratamento de dados nulos com COALESCE
 ...
 * */
select * from temp_tables.regions r limit 10;
...
-- COM COALESCE
select *,
	coalesce(population, (select avg(population) from temp_tables.regions r2)) as populacao_ajustada -- o coalesce não se limita a dois valores. É possível adicionar n itens
from temp_tables.regions r 
where population is null
;
